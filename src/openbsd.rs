...
impl Errno {
    ...
    pub const EIPSEC: Self = Self(82);
    /// Attribute not found
    pub const ENOATTR: Self = Self(83);
    /// Illegal byte sequence
    pub const EILSEQ: Self = Self(84);
    /// No medium found
    pub const ENOMEDIUM: Self = Self(85);
    /// Wrong medium type
    pub const EMEDIUMTYPE: Self = Self(86);
    /// Value too large to be stored in data type
    pub const EOVERFLOW: Self = Self(87);
    /// Operation canceled
    pub const ECANCELED: Self = Self(88);
    /// Identifier removed
    pub const EIDRM: Self = Self(89);
    /// No message of desired type
    pub const ENOMSG: Self = Self(90);
    /// Not supported
    pub const ENOTSUP: Self = Self(91);
    /// Bad message
    pub const EBADMSG: Self = Self(92);
    /// State not recoverable
    pub const ENOTRECOVERABLE: Self = Self(93);
    /// Previous owner died
    pub const EOWNERDEAD: Self = Self(94);
    /// Protocol error
    pub const EPROTO: Self = Self(95);
    /// Alias for [Self::EAGAIN]
    pub const EWOULDBLOCK: Self = Self::EAGAIN;

    pub const MIN: i32 = -2;
    pub const MAX: i32 = 95;

    #[cfg(feature = "iter")]
    pub(crate) const ALL: [i32; 97] = [
    ...
    pub(crate) fn name_and_description(&self) -> Option<(&'static str, &'static str)> {
        match self.0 {
            ...
            69 => Some(("EDQUOT", "Disk quota exceeded")),
            ...
            74 => Some(("EPROGUNAVAIL", "RPC program not available")),
            ...
            82 => Some(("EIPSEC", "IPsec processing failure")),
            83 => Some(("ENOATTR", "Attribute not found")),
            84 => Some(("EILSEQ", "Illegal byte sequence")),
            85 => Some(("ENOMEDIUM", "No medium found")),
            86 => Some(("EMEDIUMTYPE", "Wrong medium type")),
            87 => Some(("EOVERFLOW", "Value too large to be stored in data type")),
            88 => Some(("ECANCELED", "Operation canceled")),
            89 => Some(("EIDRM", "Identifier removed")),
            90 => Some(("ENOMSG", "No message of desired type")),
            91 => Some(("ENOTSUP", "Not supported")),
            92 => Some(("EBADMSG", "Bad message")),
            93 => Some(("ENOTRECOVERABLE", "State not recoverable")),
            94 => Some(("EOWNERDEAD", "Previous owner died")),
            95 => Some(("EPROTO", "Protocol error")),
            _ => None,
        }
    }
}
