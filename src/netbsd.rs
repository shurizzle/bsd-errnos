...
impl Errno {
    /// Move given fd
    pub const EMOVEFD: Self = Self(-6);
    /// Dup given fd
    pub const EDUPFD: Self = Self(-5);
    /// ioctl not handled by this layer
    pub const EPASSTHROUGH: Self = Self(-4);
    /// restart syscall
    pub const ERESTART: Self = Self(-3);
    ...
    pub const EILSEQ: Self = Self(85);
    /// Not supported
    pub const ENOTSUP: Self = Self(86);
    /// Operation canceled
    pub const ECANCELED: Self = Self(87);
    /// Bad or Corrupt message
    pub const EBADMSG: Self = Self(88);
    /// No message available
    pub const ENODATA: Self = Self(89);
    /// No STREAM resources
    pub const ENOSR: Self = Self(90);
    /// Not a STREAM
    pub const ENOSTR: Self = Self(91);
    /// STREAM ioctl timeout
    pub const ETIME: Self = Self(92);
    /// Attribute not found
    pub const ENOATTR: Self = Self(93);
    /// Multihop attempted
    pub const EMULTIHOP: Self = Self(94);
    /// Link has been severed
    pub const ENOLINK: Self = Self(95);
    /// Protocol error
    pub const EPROTO: Self = Self(96);
    /// Previous owner died
    pub const EOWNERDEAD: Self = Self(97);
    /// State not recoverable
    pub const ENOTRECOVERABLE: Self = Self(98);
    ...
    pub(crate) fn name_and_description(&self) -> Option<(&'static str, &'static str)> {
        match self.0 {
            -6 => Some(("EMOVEFD", "Move given fd")),
            -5 => Some(("EDUPFD", "Dup given fd")),
            -4 => Some(("EPASSTHROUGH", "ioctl not handled by this layer")),
            -3 => Some(("ERESTART", "restart syscall")),
            ...
            34 => Some(("ERANGE", "Result too large or too small")),
            ...
            42 => Some(("ENOPROTOOPT", "Protocol option not available")),
            ...
            85 => Some(("EILSEQ", "Illegal byte sequence")),
            86 => Some(("ENOTSUP", "Not supported")),
            87 => Some(("ECANCELED", "Operation canceled")),
            88 => Some(("EBADMSG", "Bad or Corrupt message")),
            89 => Some(("ENODATA", "No message available")),
            90 => Some(("ENOSR", "No STREAM resources")),
            91 => Some(("ENOSTR", "Not a STREAM")),
            92 => Some(("ETIME", "STREAM ioctl timeout")),
            93 => Some(("ENOATTR", "Attribute not found")),
            94 => Some(("EMULTIHOP", "Multihop attempted")),
            95 => Some(("ENOLINK", "Link has been severed")),
            96 => Some(("EPROTO", "Protocol error")),
            97 => Some(("EOWNERDEAD", "Previous owner died")),
            98 => Some(("ENOTRECOVERABLE", "State not recoverable")),
            _ => None,
        }
    }
}
